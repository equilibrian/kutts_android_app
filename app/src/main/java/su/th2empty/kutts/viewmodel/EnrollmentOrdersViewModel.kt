...
class EnrollmentOrdersViewModel(application: Application) : AndroidViewModel(application) {
    companion object {
        const val ENROLLMENT_ORDERS_WEB_URL = "https://kutts.ru/abiturientam/prikazy-o-zachislenii/"
    }
        ...
        viewModelScope.launch {
            try {
                val documents = withContext(Dispatchers.IO) {
                    HtmlParser.getPdfDocuments(ENROLLMENT_ORDERS_WEB_URL)
                }
