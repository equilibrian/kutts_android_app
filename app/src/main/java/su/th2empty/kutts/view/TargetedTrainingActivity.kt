...
class TargetedTrainingActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTargetedTrainingBinding
    private val viewModel by lazy {
        ViewModelProvider(this)[TargetedTrainingViewModel::class.java]
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTargetedTrainingBinding.inflate(layoutInflater)
